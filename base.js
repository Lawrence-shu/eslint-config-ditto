...
module.exports = {
  ...
  rules: {
    ...
    "comma-dangle": [
      "error",
      {
        "arrays": "never", // 数组的最后一项必须有逗号
        "objects": "always-multiline", // 对象的最后一项必须有逗号
        "imports": "always-multiline", // import 的最后一项必须有逗号
        "exports": "always-multiline", // export 的最后一项必须有逗号
        "functions": "never", // 函数参数的最后一项不允许逗号
      }
    ],
    /** 最大连续空白行1行， */
    ...
    /** 数组括号内没有多余空格 */
    "array-bracket-spacing": ["error", "never"], // 确保数组括号内没有多余空格
    /** 强制缩进2个空格 */
    "indent": ["error", 2],
    /** 要求双引号 */
    "quotes": ["error", "double"],
